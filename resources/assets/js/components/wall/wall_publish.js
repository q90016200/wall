...
export default class Wall_post_publish extends React.Component {
    ...
    render(){
        ...
        let photo_div = null;
        if (this.state.share_status){
            share_div = <Wall_post_publish_share img={this.state.share_div_img} title={this.state.share_div_title}  description={this.state.share_div_description} url={this.state.share_div_url} onCloseClick={this.handlePublishShareCancel}  />;  
        }
