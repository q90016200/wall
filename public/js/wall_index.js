...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wall_post_comment_component_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wall_post_comment_publish_component_js__ = __webpack_require__(26);
...
var Wall_post_component = function (_React$Component) {
    ...
    _createClass(Wall_post_component, [{
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                this.state.items.map(function (item, index) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Wall_post_head, { name: item.user.name, time: item.create_date, post_id: item.post_id }),
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__wall_post_comment_component_js__["a" /* default */], { items: item.comment_data.comments, onRemove: _this2.commentRemove }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__wall_post_comment_publish_component_js__["a" /* default */], { post_id: item.post_id, itemNum: index, onPublish: _this2.commentPublish })
                    );
                })
            );
        }
        ...
        key: 'commentPublish',
        value: function commentPublish(event, itemNum, comments) {
            var prevItem = this.state.items;

            var prevComments = prevItem[itemNum].comment_data.comments;
            var newComments = prevComments.concat(comments);
        ...
        key: 'commentRemove',
        value: function commentRemove(event, commentId) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'a',
                            { className: 'dropdown-item', onClick: this.copyLink },
                            '\u8907\u88FD\u9023\u7D50'
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'a',
...
var Wall_post_content = function (_React$Component3) {
    ...
    function Wall_post_content(props) {
        ...
        var _this4 = _possibleConstructorReturn(this, (Wall_post_content.__proto__ || Object.getPrototypeOf(Wall_post_content)).call(this, props));
...
var Wall_post_link_preview = function (_React$Component4) {
    ...
    function Wall_post_link_preview(props) {
        ...
        var _this5 = _possibleConstructorReturn(this, (Wall_post_link_preview.__proto__ || Object.getPrototypeOf(Wall_post_link_preview)).call(this, props));
...
var Wall_post_comment_component = function (_React$Component) {
    ...
    _createClass(Wall_post_comment_component, [{
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        item.is_edit && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            'button',
                                            { type: 'button', className: 'close position-absolute', 'aria-label': 'Close', onClick: function onClick(event) {
                                                    return _this2.commentRemove(event, item.comment_id);
                                                } },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                'span',
                                                { 'aria-hidden': 'true' },
        ...
        key: 'commentRemove',
        value: function commentRemove(event, comment_id) {
            var ts = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_wall_wall_post_publish_component_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_wall_wall_post_component_js__ = __webpack_require__(8);
...
function getPostLatest() {
	...
	if (getPostLatestState.status) {
		...
		axios.get("/wall/posts", {
			...
			__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_wall_wall_post_component_js__["a" /* default */], { items: response.data.posts, append: 'after' }), document.getElementById('wall_posts'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wall_post_component_js__ = __webpack_require__(8);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
        ...
        value: function publishClick(event) {
            ...
            if (this.state.publish_status && (textarea_value.length > 0 || this.state.url_perview_status || this.state.photo_status)) {
                ...
                axios({
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__wall_post_component_js__["a" /* default */], { items: data.posts_data, append: 'before' }), document.getElementById('wall_posts'));
                });
            } else {
...
var Wall_post_comment_publish_component = function (_React$Component) {
    _inherits(Wall_post_comment_publish_component, _React$Component);

    function Wall_post_comment_publish_component(props) {
        _classCallCheck(this, Wall_post_comment_publish_component);

        var _this = _possibleConstructorReturn(this, (Wall_post_comment_publish_component.__proto__ || Object.getPrototypeOf(Wall_post_comment_publish_component)).call(this, props));
        ...
        _this.commentPublish = _this.commentPublish.bind(_this);
        _this.commentInputChange = _this.commentInputChange.bind(_this);
    ...
    _createClass(Wall_post_comment_publish_component, [{
        ...
        key: 'commentPublish',
        value: function commentPublish(e) {
...
/* harmony default export */ __webpack_exports__["a"] = (Wall_post_comment_publish_component);
