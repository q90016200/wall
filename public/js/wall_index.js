...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wall_post_comment_component_js__ = __webpack_require__(68);
...
var Wall_post_component = function (_React$Component) {
    _inherits(Wall_post_component, _React$Component);

    function Wall_post_component(props) {
        _classCallCheck(this, Wall_post_component);

        var _this = _possibleConstructorReturn(this, (Wall_post_component.__proto__ || Object.getPrototypeOf(Wall_post_component)).call(this, props));
        ...
        _this.postRemove = _this.postRemove.bind(_this);

        return _this;
    }

    _createClass(Wall_post_component, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                this.state.items.map(function (item, index) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: ' my-3 p-3 bg-white rounded border-bottom', key: "post_" + item.post_id },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Wall_post_head, { name: item.user.name, time: item.create_date.date, post_id: item.post_id, onRemove: _this2.postRemove }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Wall_post_content, { content: item.content }),
                        typeof item.preview != "undefined" && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Wall_post_link_preview, { item: item.preview }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__wall_post_comment_component_js__["a" /* default */], { post_id: item.post_id, comment_count: item.comment_count })
                    );
                })
            );
        }
        ...
        value: function handleScroll(e) {
            ...
            if (ts.state.loadPost) {
                ...
                var el_wall_content = document.getElementById("wall_posts");
        ...
        key: 'postRemove',
        value: function postRemove(event, post_id) {
            var ts = this;

            axios.delete('/wall/posts/' + post_id).then(function (response) {

                // 要回到父層才能變更items
                var prevPosts = ts.state.items;
    ...
    return Wall_post_component;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

// Prop 預設值，若對應 props 沒傳入值將會使用 default 值 null


/* harmony default export */ __webpack_exports__["a"] = (Wall_post_component);
Wall_post_component.defaultProps = {
    append: null
};

var Wall_post_head = function (_React$Component2) {
    _inherits(Wall_post_head, _React$Component2);

    function Wall_post_head(props) {
        _classCallCheck(this, Wall_post_head);

        var _this3 = _possibleConstructorReturn(this, (Wall_post_head.__proto__ || Object.getPrototypeOf(Wall_post_head)).call(this, props));

        _this3.state = {
            isCopy: true
        };

        _this3.copyLink = _this3.copyLink.bind(_this3);
        _this3.copyLinkSpan = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef();
        return _this3;
    }
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'col-auto' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: '/img/avatar.jpg', alt: '...', className: 'rounded-circle', style: { width: 40 + 'px', height: 40 + 'px' } })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            { className: 'dropdown-item', onClick: function onClick(event) {
                                    return _this4.copyLink(event, _this4.props.post_id);
                                } },
                            '\u8907\u88FD\u9023\u7D50'
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'a',
                            { className: 'dropdown-item', onClick: function onClick(event) {
                                    ts.props.onRemove(event, ts.props.post_id);
                                } },
                            '\u522A\u9664'
                        )
                    )
    ...
    return Wall_post_head;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

var Wall_post_content = function (_React$Component3) {
    _inherits(Wall_post_content, _React$Component3);

    function Wall_post_content(props) {
        _classCallCheck(this, Wall_post_content);

        var _this5 = _possibleConstructorReturn(this, (Wall_post_content.__proto__ || Object.getPrototypeOf(Wall_post_content)).call(this, props));
    ...
    _createClass(Wall_post_content, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
        ...
        key: 'render',
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'my-3', dangerouslySetInnerHTML: export_html(this.state.content) });
        }
    }]);

    return Wall_post_content;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

var Wall_post_link_preview = function (_React$Component4) {
    _inherits(Wall_post_link_preview, _React$Component4);

    function Wall_post_link_preview(props) {
        _classCallCheck(this, Wall_post_link_preview);

        var _this6 = _possibleConstructorReturn(this, (Wall_post_link_preview.__proto__ || Object.getPrototypeOf(Wall_post_link_preview)).call(this, props));

        _this6.state = {};
        return _this6;
    }

    _createClass(Wall_post_link_preview, [{
        key: 'render',
        value: function render() {
            var isYoutube = this.props.item.youtube;
            var linkImg = null;
            if (this.props.item.link_image) {
                linkImg = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { className: 'card-img-top', src: this.props.item.link_image });
            }

            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                null,
                isYoutube ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'embed-responsive embed-responsive-16by9' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('iframe', { className: 'embed-responsive-item', src: "https://www.youtube.com/embed/" + this.props.item.youtube })
                ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'card mt-3 ' },
                    linkImg,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'p',
                            { className: 'card-text' },
                            this.props.item.link_description
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'p',
                            { className: 'card-text' },
...
// find url in string
var wrapPostContentURLs = function wrapPostContentURLs(text, new_window) {
    var url_pattern = /((https?|telnet|ftp):[\/\/[\.\-\_\/a-zA-Z0-9\~\?\%\#\=\@\:\&\;\*\\\-]+?)(?=[.:?\\-]*(?:[^\/\/[\.\-\_\/a-zA-Z0-9\~\?\%\#\=\@\:\&\;\*\\\-]|$))/;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_router_dom__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_wall_wall_post_publish_component_js__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_wall_wall_post_component_js__ = __webpack_require__(27);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Index = function (_React$Component) {
    ...
    function Index(props) {
        ...
        _this.uploadItems = _this.uploadItems.bind(_this);
    ...
    _createClass(Index, [{
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["c" /* Route */], { exact: true, path: '/', render: function render() {
                            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_wall_wall_post_publish_component_js__["a" /* default */], { username: user.name, onPublish: _this2.uploadItems }),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_wall_wall_post_component_js__["a" /* default */], { items: _this2.state.items, append: _this2.state.append })
                            );
                        } }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["c" /* Route */], { path: '/posts/:id', render: function render(_ref) {
                            var match = _ref.match;
                            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_wall_wall_post_component_js__["a" /* default */], { items: [], post_id: match.params.id });
                        } })
                )
            );
        }
        ...
        key: 'uploadItems',
        value: function uploadItems(items, type) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wall_post_component_js__ = __webpack_require__(27);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Wall_post_publish_component = function (_React$Component) {
    ...
    _createClass(Wall_post_publish_component, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'my-3 p-3 bg-white rounded border-bottom', onClick: this.checkLogin },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'row bd-highlight mb-3' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'col-auto mr-auto' },
...
function Wall_post_publish_share(props) {
    ...
    if (props.img) {
        shareImg = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { className: 'card-img-top', src: props.img });
    }
...
var Wall_post_comment_component = function (_React$Component) {
    _inherits(Wall_post_comment_component, _React$Component);

    function Wall_post_comment_component(props) {
        _classCallCheck(this, Wall_post_comment_component);

        var _this = _possibleConstructorReturn(this, (Wall_post_comment_component.__proto__ || Object.getPrototypeOf(Wall_post_comment_component)).call(this, props));
        ...
        };_this.commentRemove = _this.commentRemove.bind(_this);
        _this.commentPublish = _this.commentPublish.bind(_this);

        return _this;
    }

    _createClass(Wall_post_comment_component, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: outsideDivClass },
                this.state.comments.map(function (item, index) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { key: "comment_" + item.comment_id, className: 'my-3' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'div',
                            { className: 'row' },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'col-auto' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: '/img/avatar.jpg', className: 'rounded-circle', style: { width: 40 + 'px', height: 40 + 'px' } })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'col-auto mr-auto' },
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        item.is_edit == 1 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            'button',
                                            { type: 'button', className: 'close position-absolute', 'aria-label': 'Close', onClick: function onClick(event) {
                                                    return _this2.commentRemove(event, index, item.comment_id);
                                                } },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                'span',
                                                { 'aria-hidden': 'true' },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Wall_post_comment_publish_component, { post_id: this.props.post_id, onPublish: this.commentPublish })
            );
        }
        ...
        key: 'commentRemove',
        value: function commentRemove(event, index, comment_id) {
            var ts = this;
                ...
                swal({
                    ...
                    if (willDelete) {
                        axios.delete('/wall/posts/' + ts.props.post_id + '/comments/' + comment_id).then(function (response) {
                            ...
                            if (data.error == false) {
                                var prevComments = ts.state.comments;
        ...
        key: 'commentPublish',
        value: function commentPublish(event, comment) {
    ...
    return Wall_post_comment_component;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

/* harmony default export */ __webpack_exports__["a"] = (Wall_post_comment_component);

var Wall_post_comment_publish_component = function (_React$Component2) {
    _inherits(Wall_post_comment_publish_component, _React$Component2);

    function Wall_post_comment_publish_component(props) {
        _classCallCheck(this, Wall_post_comment_publish_component);

        var _this3 = _possibleConstructorReturn(this, (Wall_post_comment_publish_component.__proto__ || Object.getPrototypeOf(Wall_post_comment_publish_component)).call(this, props));
        ...
        _this3.commentPublish = _this3.commentPublish.bind(_this3);
        _this3.commentInputChange = _this3.commentInputChange.bind(_this3);

        return _this3;
    }

    _createClass(Wall_post_comment_publish_component, [{
        key: 'render',
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', className: 'form-control', placeholder: '\u7559\u8A00...', 'aria-label': '\u7559\u8A00...', 'aria-describedby': 'basic-addon2', value: this.state.commentInputVal, onChange: this.commentInputChange, maxLength: '500' }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'input-group-append' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'button',
                            { className: 'btn btn-outline-secondary', type: 'button', onClick: this.commentPublish },
                            '\u9001\u51FA'
                        )
                    )
                )
        ...
        key: 'commentInputChange',
        value: function commentInputChange(event) {
            var str = event.target.value;
            var ts = this;
        ...
        key: 'commentPublish',
        value: function commentPublish(event) {
    ...
    return Wall_post_comment_publish_component;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);
