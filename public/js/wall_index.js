...
function getPostLatest() {
	...
	if (getPostLatestState.status) {
		...
		axios.get("/api/wall/posts/latest", {
			...
			__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_wall_wall_post_component_js__["a" /* default */], { items: response.data.posts_data }), document.getElementById('wall_posts'));
...
function Wall_post_publish_share(props) {
    ...
    if (props.img) {
        shareImg = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { className: 'card-img-top', src: props.img, alt: 'Card image cap' });
    }
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                this.state.items.map(function (item) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Wall_post_content, { item: item })
                    );
                })
            );
        }
...
var Wall_post_content = function (_React$Component3) {
    ...
    function Wall_post_content(props) {
        ...
        _this3.state = {
            content: _this3.props.item.content
        };
        return _this3;
    }
    ...
    _createClass(Wall_post_content, [{
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'my-3' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'my-3', dangerouslySetInnerHTML: export_html(this.state.content) })
            );
        }
    }]);
